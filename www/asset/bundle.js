...
/***/ function(module, exports, __webpack_require__) {
	...
	var doAddTodo_1 = __webpack_require__(22);
	var doToggleTodo_1 = __webpack_require__(23);
	var initialState = new models_1.TodoList();
	exports.todoStateReducer = function (state, action) {
	    if (state === void 0) { state = initialState; }
	    if (action.type === doAddTodo_1.ADD_TODO) {
	        var payload = action.payload;
	        var newState = objectAssign(new models_1.TodoList(), state);
	        newState.addNewTask(payload.text);
	        return newState;
	    }
	    else if (action.type === doToggleTodo_1.TOGGLE_TODO) {
	        var payload = action.payload;
	        var target = state.findById(payload.id);
	        if (!!target) {
...
/***/ function(module, exports) {
	...
	var TodoList = (function (_super) {
	    ...
	    TodoList.prototype.addNewTask = function (aText) {
	        var task = new TodoTask(this.length, aText);
	        this.push(task);
	        return task;
	    };
...
/***/ function(module, exports) {
	...
	exports.doToggleTodo = doToggleTodo;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var models_1 = __webpack_require__(21);
	var doSetVisibilityFilter_1 = __webpack_require__(25);
	var initialState = models_1.VisibilityFilter.ShowAll;
	exports.visibilityFilterStateReducer = function (state, action) {
	    if (state === void 0) { state = initialState; }
	    if (action.type === doSetVisibilityFilter_1.SET_VISIBILITY_FILTER) {
	        var payload = action.payload;
...
/***/ function(module, exports) {
	...
	function doSetVisibilityFilter(aFilter) {
	    return {
	        type: exports.SET_VISIBILITY_FILTER,
	        payload: {
	            filter: aFilter,
	        },
	    };
